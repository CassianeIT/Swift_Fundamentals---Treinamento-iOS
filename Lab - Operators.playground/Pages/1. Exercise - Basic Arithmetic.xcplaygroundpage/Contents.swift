 ...
 */
var divisao = 10 / 3
let integerDivisionResult = divisao
...
let impart = 3
var restopar = par % 2
var restoimpar = impart % 2

print(restopar + restoimpar)

 ...
 */
let favoriteQuote = "Minha citação favorita é \"Não considere nenhuma prática como imutável. Mude e esteja pronto a mudar novamente. Não aceite a verdade eterna. Experimente.\""

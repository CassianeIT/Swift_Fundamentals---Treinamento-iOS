...
var favoriteBook = Book(title: "Tara Duncan", author: "Sophie Audouin-mamikonian", pages: 550, price: 12.00)

print("Meu livro favorito é \(favoriteBook.title), que foi escrito por \(favoriteBook.author). O livro tem \(favoriteBook.pages) pagínas e custa \(favoriteBook.price)")
/*:
...
struct Height {
    ...
    var heightInCentimenters: Double
    
    init(heightInInches: Double) {
        self.heightInInches = heightInInches
        self.heightInCentimenters = heightInInches * 2.54
    }
    init(heightInCentimenters: Double) {
        self.heightInCentimenters = heightInCentimenters
        self.heightInInches = heightInCentimenters / 2.54
    }
}
...
print(someonesHeight.heightInCentimenters)

someonesHeight = Height(heightInCentimenters: 165.1)
 ...
 */
var minhaaltura = Height(heightInCentimenters: 164)
print(minhaaltura.heightInInches)

 ...
 */
var casssiane = User(name: "Cassiane", age: 24, height: 1.64, weight: 72.80, activityLevel: 1)
print("My nome é \(casssiane.name). Eu tenho \(casssiane.age). \(casssiane.height) de altura e peso \(casssiane.weight). O meu nível de atividade é \(casssiane.activityLevel)")
